...
public class HomeChiefNearByModel implements Serializable {
    ...
    private String latitude = "28.5244";
    private String longitude = "77.1855";
    ...
    public ArrayList<String> getCoverPhotoArrayList() {
