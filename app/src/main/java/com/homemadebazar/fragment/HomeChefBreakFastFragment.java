...
public class HomeChefBreakFastFragment extends BaseFragment {
    ...
    protected void setData() {
        getHomeChefBreakfastOrders();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_home_chef_breakfast, container, false);
        return view;
    }

    private void getHomeChefBreakfastOrders() {
        try {
