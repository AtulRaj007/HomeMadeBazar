...
public class FoodieTopDealsFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void setData() {
        ...
        getHomeChefHotDealsOrders(userModel.getUserId(), Constants.DiscoverTab.TopDeals);
    }
