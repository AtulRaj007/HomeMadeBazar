...
import com.munchmash.Template.Template;
...
public class MultiPartRequest extends Request<String> {
    ...
    public MultiPartRequest(Response.ErrorListener errorListener, Response.Listener listener, ArrayList<File> file, int numberOfFiles, String path) {
